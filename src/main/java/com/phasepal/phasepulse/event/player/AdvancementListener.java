...
public class AdvancementListener {
	...
	static {
		// Find the advancement-like field in AdvancementToast using reflection.
		// 1.20.1 and 1.21+ use different advancement classes.
		try {
	...
	private static Object extractAdvancementObject(AdvancementToast toast) {
		try {
			...
			// Fallback: rescan fields if static detection failed.
