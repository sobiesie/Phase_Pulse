...
public class PhasePulseConfig {
    ...
    public boolean sendChatCommands = true;
    ...
    public boolean validate() {
        ...
        // Validate chat command settings
        if (chatCommandCooldownMs < 100 || chatCommandCooldownMs > 10000) {
            return false;
        }
        if (maxChatMessageLength < 1 || maxChatMessageLength > 2000) {
            return false;
        }
